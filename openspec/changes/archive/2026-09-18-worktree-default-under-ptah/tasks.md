...
- [x] 1.3 Update the module header comment, the `ProvisionOptions.parent` doc, and the environment note (git, gh, and now `.ptah/worktree/` ignored) to describe the new default and the `git clean -fdx` trade-off
